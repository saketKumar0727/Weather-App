...
def data_get():
    city=city_name.get()
    data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+ city + "&appid=cfc6a975d74162a6ebc284bc8c502ae3").json()
    print(data)
    w_label1.config(text=data["weather"][0]["main"])
    wb_label1.config(text=data["weather"][0]["description"])
    temp_label1.config(text=str(data["main"]["temp"]-273.5))
...
com=ttk.Combobox(win, text="Wscube Weater App",values=list_name, font=("Time New Roman ",20,"bold"),textvariable=city_name)
